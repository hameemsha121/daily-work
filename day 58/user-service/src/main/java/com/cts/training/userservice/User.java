...
public class User implements Serializable{
	...
	public User(Integer id, String name, String email, long phone, String username, String password, String role,
	...
	public String toString() {
		return "User [id=" + id + ", name=" + name + ", email=" + email + ", phone=" + phone + ", username=" + username
				+ ", password=" + password + ", role=" + role + ", regStatus=" + regStatus + ", active=" + active + "]";
	}
